...
public class actividad extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.activity_graficas,container,false);
        MainActivity.toolbar.getMenu().clear();
        text = (TextView) v.findViewById(R.id.titulo);
        text2 = (TextView) v.findViewById(R.id.titulo2);
        text.setText("Pasos");
        text2.setText("Pasos");
        ...
        BarChart chart2 = (BarChart) v.findViewById(R.id.chart2);
    ...
    private ArrayList<BarDataSet> getDataSet() {
        ...
        String x="";
        SQLiteDatabase db2 = v.getContext().openOrCreateDatabase("MyDB", Context.MODE_PRIVATE, null);
